 ...
 * @group      selenium
 */
class ViewEditTest extends TestBase
{
    /**
     * @return void
     */
    ...
    public function testRenameView()
    {
        ...
        $this->waitAjax();
        $this->byId("structure-action-links")->byCssSelector("a:first-child ")->click();
        $this->waitAjax();
        $this->typeInTextArea( 'SELECT id FROM test_table WHERE 1',0);
